pipeline {
    ...
    environment {
        NEXUS_URL = 'http://18.188.218.38:8081' 
        NEXUS_REPO_JAR = 'my-maven-releases'     
        ARTIFACT_PATH = 'target/backend-0.0.1-SNAPSHOT.jar'
        GITHUB_REPO = 'https://github.com/phanikumar16/project'
        BRANCH = 'master'                       
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: 'github-cred', usernameVariable: 'GIT_USERNAME', passwordVariable: 'GIT_PASSWORD')]) {
                    sh """
                        ...
                        git push https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/phanikumar16/project.git HEAD:${BRANCH}
                    """
                }
            }
        }
